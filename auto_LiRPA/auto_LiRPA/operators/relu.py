...
class BoundTwoPieceLinear(BoundOptimizableActivation):
    ...
    def bound_backward(self, last_lA, last_uA, x=None, start_node=None,
        ...
        if self.cut_used:
            ...
            ub_upper_d = ub_upper_d[0] if ub_upper_d is not None else None
            ub_lower_d = ub_lower_d[0] if ub_lower_d is not None else None
            ub_upper_b = ub_upper_b[0] if ub_upper_b is not None else None
            lb_lower_d = lb_lower_d[0] if lb_lower_d is not None else None
            lb_upper_d = lb_upper_d[0] if lb_upper_d is not None else None
            lb_upper_b = lb_upper_b[0] if lb_upper_b is not None else None
